...
The format follows [Keep a Changelog](https://keepachangelog.com/en/1.1.0/), and the project intends to use semantic versioning once tagged releases begin. Until then, changes remain under `Unreleased` and must not be represented as a published version.
...
- Isolated installation smoke test, package validator, governance documents, and contribution templates.
